...
![](https://github.com/vladislavpyatnitskiy/financial.data.visualisation/blob/main/barplot/Barplot%20Correlation.png?raw=true)

Additionally, it is possible to use barplot to check correlations between selected security and other ones.
